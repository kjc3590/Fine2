...
<link href="assets/css/young2.css" rel="stylesheet">
...
<!-- 					<li data-target="#carousel-example-generic" data-slide-to="1"></li> -->
				...
				<%
					if(mobileCheck=="1"){
				%>
						<img src="assets/images/about_1_mobile.png" class="back">
				<%		
					}else{
				%>
						<img src="assets/images/about_1.png" class="back">
				<%		
					}
				%>
				...
				<%
					if(mobileCheck=="1"){
				%>
						<img src="assets/images/about_2_mobile.png" class="back">
				<%		
					}else{
				%>
						<img src="assets/images/about_2.png" class="back">
				<%		
					}
				%>
							<div class="wrap-hero-content">
