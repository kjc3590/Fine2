							...
							<div class="col-md-4">
								...
								<div class="col-md-7">
									...
									<div class="form_group">
										<div class="fg-line">
											<div class="form-control">
												<input type="text" class="chang2 form-control" value="<%=reply_method %>" name="reply_method" readonly="readonly" >
											</div>
										</div>
									</div>
							...
							<div class="col-md-4">
								...
								<div class="col-md-7">
									...
									<div class="form_group">
										<div class="fg-line">
											<div class="form-control">
												<input type="text" class="chang2 form-control" value="完成预定日期"
								...
								<div class="col-md-2">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="button" value="确定" class="btn btn-two m-r-10" type="button">
									...
									<div class="col-md-6">
										<div class="form-group">
										<a href = "Lime_list.jsp">
											<input type="button" value="取消" class="btn btn-two m-r-10" type="button">
