							...
							<div class="col-md-6 no-padding">
								<form name="serach" method="post" class="form1">
									<select class="choice" name="keyField">
										...
										<option value="translation_korean">KOREA</option>
										<option value="translation_manager_korean">STAFF(KOR)</option>
										<option value="translation_english">영어</option>
										<option value="translation_manager_english">STAFF(ENG)</option>
										<option value="translation_chinese">중국어</option>
										<option value="translation_manager_chinese">STAFF(CH)</option>
							...
							<div class="col-md-6 no-padding" style="display: flex;">
								<form name="sort" method="post" class="form1">
									<select class="choice" name="sort">
										<option value="">----CHOICE----</option>
										<option value="translation_id">NEW</option>
										<option value="translation_type">NO-TRANSLATION</option>
										<option value="translation_cday">TRANSLATION SUCCESS</option>
								...
								<form name="serach" action="../util/reset.jsp"
									...
									<input type="hidden" value="trans" name="what"> <input
										class="btn-Lime btn" type="submit" value="RESET">
								</form>
							</div>
						...
						<div class="table-responsive">
							...
							<form class="form-horizontal" name="update"
								...
								<div class="lazenca">
									<div class="totoyo">
										<p class="young0">
											<input class="btn-Lime btn" type="submit" value="SAVE">
										</p>
									</div>
								</div>
								...
								<table id="data-table-selection"
									...
									<thead>
										<tr class="tr-color">
											<th class="table-sort"
												style="border-left: 1px solid transparent; text-align: center; width:70px;">*</th>
											<th class="table-sort">KOREA</th>
											<th class="table-sort">CHINESE</th>
											<th class="table-sort">ENGLISH</th>
											<th class="table-sort">RUSSIAN</th>
											<th class="table-sort">REGIST TIME</th>
											<th class="table-sort">COMPLATE TIME</th>
										</tr>
									</thead>
									...
									<tbody>
										...
										<tr class="tran warning">
											...
											<td><input id="input_ch" class="form-control4"
												type="text" readonly="readonly" name="trans_ch<%=ii%>"
												value="<%=resv.getTranslation_chinese()%>"></td>
											<td><input id="input_eng" class="form-control4"
												type="text" name="trans_eng<%=ii%>" autofocus="autofocus"
										...
										<tr class="tran">
											...
											<td><%=resv.getTranslation_korean()%></td>
											<td><input id="input_ch" class="form-control4"
												type="text"  name="trans_ch<%=ii%>" readonly="readonly"
												value="<%=resv.getTranslation_chinese()%>"></td>
											<td><input id="input_eng" class="form-control4"
												type="text" name="trans_eng<%=ii%>" autofocus="autofocus"
												value="<%=resv.getTranslation_english()%>"></td>
