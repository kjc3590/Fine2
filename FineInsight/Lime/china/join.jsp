   ...
   <div class="container">
      ...
      <div class="card">
         ...
         <div class="card-header">
            <h3 style="text-align: center;">注册会员</h3>
            ...
            <div class="col-md-12">
               <form class="form-horizontal" action="../util/joinUtil.jsp" method="post">
                  ...
                  <div class="form-group">
                     <label for="id" class="col-sm-2 col-sm-offset-1 control-label">帐号</label>
                     <div class="col-sm-8">
                        <input type="text" class="form-control" id="Id" placeholder="帐号" name="id">
                     </div>
                  </div>

                  <div class="form-group">
                     <label for="inputPassword3"
                        class="col-sm-2 col-sm-offset-1 control-label">密码</label>
                     <div class="col-sm-8">
                  ...
                  <div class="form-group">
                     <label for="이메일" class="col-sm-2 col-sm-offset-1 control-label">电子邮件</label>
                     <div class="col-sm-8">
                        <input type="text" class="form-control" id="email" name ="email"
                           placeholder="电子邮件">
                     </div>
                  </div>
                        <input type="hidden" class="form-control" id="country" name ="country" value="china">
               ...
               <div class="haha col-md-12">
                     ...
                     <button class="btn-no sizeB" type="button" onclick="location.href='../china/index.jsp' ">取消</button>
               </div>
