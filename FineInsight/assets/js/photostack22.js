			...
			self.allItems.forEach( function( item, i ) {
				...
				if(self.items.indexOf(item) === self.current && self.started && iter === 0) {
					...
					if(translation.x>800){
						item.style.WebkitTransform = 'translate(' + Math.abs(translation.x)+60 + 'px,' + translation.y + 'px) rotate(' + Math.floor( Math.random() * (maxrot - minrot + 1) + minrot ) + 'deg)';
						item.style.msTransform = 'translate(' + Math.abs(translation.x)+60 + 'px,' + translation.y + 'px) rotate(' + Math.floor( Math.random() * (maxrot - minrot + 1) + minrot ) + 'deg)';
						item.style.transform = 'translate(' + Math.abs(translation.x)+60 + 'px,' + translation.y + 'px) rotate(' + Math.floor( Math.random() * (maxrot - minrot + 1) + minrot ) + 'deg)';
					}else{
						item.style.WebkitTransform = 'translate(' + Math.abs(translation.x) + 'px,' + translation.y + 'px) rotate(' + Math.floor( Math.random() * (maxrot - minrot + 1) + minrot ) + 'deg)';
						item.style.msTransform = 'translate(' + Math.abs(translation.x) + 'px,' + translation.y + 'px) rotate(' + Math.floor( Math.random() * (maxrot - minrot + 1) + minrot ) + 'deg)';
						item.style.transform = 'translate(' + Math.abs(translation.x) + 'px,' + translation.y + 'px) rotate(' + Math.floor( Math.random() * (maxrot - minrot + 1) + minrot ) + 'deg)';
					}
				}
