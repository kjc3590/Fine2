...
<script>
	...
	function printTime() {
		...
		if(now.getHours()<10){
			TTime = ("0"+now.getHours()+""+now.getMinutes()+""+now.getSeconds());
			if(now.getMinutes()<10){
				TTime = ("0"+now.getHours()+"0"+now.getMinutes()+""+now.getSeconds());
			}
			if(now.getSeconds()<10){
				TTime = ("0"+now.getHours()+"0"+now.getMinutes()+"0"+now.getSeconds());
			}
		}else if(now.getMinutes()<10){
			
			TTime = (""+now.getHours()+"0"+now.getMinutes()+""+now.getSeconds());
			
			if(now.getSeconds()<10){
				TTime = (""+now.getHours()+"0"+now.getMinutes()+"0"+now.getSeconds());
			}
		}else if(now.getSeconds()<10){
			TTime = (""+now.getHours()+""+now.getMinutes()+"0"+now.getSeconds());
		}else{
			TTime = (now.getHours()+""+now.getMinutes()+""+now.getSeconds());
		}
			console.log(TTime);
			...
			LupangMoney = Math.round(LupangMoney + 3.05);
			
			if(090000<=TTime && TTime<=180000){
				...
				document.getElementById("Lupang").innerHTML = "루팡머니는 " + LupangMoney + "원 입니다."; 
	  		}else{
				document.getElementById("now").innerHTML = nowTime; 
				document.getElementById("gohome").innerHTML = gohomeTime; 
				document.getElementById("GO").innerHTML = "업무시간이 아닙니다."; 
				document.getElementById("Lupang").innerHTML = LupangMoney + "원 입니다."; 
	  		}
			...
			<div class="wrap-hero-content">
				<div class="hero-content">
					<img src="assets/images/fine-logo.png" class="wow fadeInRight" data-wow-duration="1.4s" data-wow-delay="1.4s"> <br> 
						...
						<br>
						<span class ="time" id="Lupang">  </span>
						<br>
				</div>
			</div>
