	...
	<section id="content">
		...
		%>
					<tr  class="success">
						...
						<td><button type="button" class="btn btn-success" >APPROVAL SUCCESS</button></td>
					</tr>
		<% 
						}else{
		%>
					<tr>
						...
						<td><%=join.getMember_tel() %></td>
						<td><%=join.getMember_day()%></td>
						<td><input type="button" class="btn btn-primary" value="APPROVAL" onclick="location.href='../util/joinAcceptUtil.jsp?id=<%=join.getMember_id()%>'"></td>
					</tr>
		<% 
						}
				}
						...
						<div class="yoho">
							...
							<nav>
								<ul class="pagination">
									...
									%>
									<li>
										<a href="english/join_accept.jsp?pageNum=<%=startPage - 1%>" aria-label="Previous"> 
									...
									%>
									<li>
										<a href="english/join_accept.jsp?pageNum=<%=i%>"><%=i%>
										 	<span class="sr-only">(current)</span>
										</a>
									</li>
									<%
									...
									%>
									<li>
										<a	href="english/join_accept.jsp?pageNum=<%=startPage + pageBlock%>"aria-label="Next"> 
