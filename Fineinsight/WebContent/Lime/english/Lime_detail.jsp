									...
									<div class="form-group">
										<div class="fg-line">
											<textarea class="leftm form-control" rows="8" name="content"
												readonly="readonly"><%=question_content%></textarea>
										</div>
								...
								<div class="col-md-4 no-padding">
									...
									<div class="col-md-4 no-padding">
										<div class="form-group"
											...
											<a href="Lime_modify.jsp?q_id=<%=q_id%>"> <input
												class="btn btn-two m-r-10" value="MODIFY" type="button">
											</a>
										</div>
									</div>
									<%
									...
									<div class="col-md-4 no-padding">
										<div class="form-group"
											...
											<a href="Lime_list.jsp"> <input
												class="btn btn-two m-r-10" value="SAVE" type="button">
											</a>
										</div>
									</div>
									<%
									...
									<div class="col-md-4 no-padding">
										<div class="form-group" style="float: right;">
											<a href="Lime_list.jsp"> <input
												class="btn btn-two m-r-10" value="CANCEL" type="button">
											</a>
										</div>
