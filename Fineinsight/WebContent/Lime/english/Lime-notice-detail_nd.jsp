		...
		<div class="container">
			...
			<div class="card">
				...
				<div class="card-header" style="padding:23px 6px;">
					<h2 class="line first"><a href ="english/Lime-notice_nd.jsp">공지사항</a></h2>
					<h2 class="first-line"><a href ="english/Lime-FAQ_nd.jsp">FAQ</a></h2>
				</div>
				...
				<div class="col-md-1 nopadding">
					<button class="btn1 btn-LimeA" onclick=" location.href='english/Lime-notice_nd.jsp' ">목록</button>
				</div>
