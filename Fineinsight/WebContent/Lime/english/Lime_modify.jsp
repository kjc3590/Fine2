			...
			<div class="card">
				...
				<div class="card-body card-padding">
					<form class="form-horizontal" name="frm1"
						action="../util/questionModifyUtil.jsp" method="post"
										...
										<div class="fg-line">
											<div class="form-control">
												<input type="text" class="form-control chang2"
													name="company_name" value="<%=cname%>" readonly="readonly">
											</div>
							...
							<div class="col-md-4">
								<div class="coco col-md-5">
									...
									<div class="form_group">
										<div class="fg-line">
											<div class="form-control1">
												<p style="padding-top: 12px;">CELLPHONE</p>
											</div>
								...
								<div class="down col-md-7">
									<div class="form_group">
										<div class="fg-line">
											<div class="form-control">
												<input type="text" class="form-control chang2"
													name="member_name" value="<%=name%>" readonly="readonly">
											</div>
										...
										<div class="fg-line">
											<div class="form-control">
												<select id="" class="chang form-control" name="division">
													...
													<option value="OTHERS"
														<%="OTHERS".equals(question_division) ? "selected" : ""%>>기타</option>
												</select>
											</div>
									...
									<div class="form-group">
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<span class="btn btn-primary1 btn-file m-s-10"
												...
												<span class="fileinput-new">FILE SELECT</span> <input
								...
								%>
									<div class="form-group">
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<span class="btn btn-primary1 btn-file m-s-10"
												style="padding-top: 13px; font-weight: 600; text-align: center; color: #333333; font-size: 16px; border-radius: 0px; box-shadow: none;">
												<span class="fileinput-new"><%=question_filename %> |
													MODIFY</span> <input type="file" name="uploadFile">
											</span> <span class="fileinput-filename"></span> <a href="#"
												class="close fileinput-exists" data-dismiss="fileinput">&times;</a>
										</div>
									</div>
									<input type="hidden" value="<%=question_attach%>"
										name="q_attach"> <input type="hidden"
										value="<%=question_filename %>" name="q_filename">
									<%		
									}
								%>
								</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											<input class="btn btn-two m-r-10" type="submit"
												value="REGIST" style="margin-left: -25px;">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<a href="Lime_list.jsp"> <input
												class="btn btn-two m-r-10" type="button" value="CANCEL">
											</a>
										</div>
