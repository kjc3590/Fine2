            ...
            <div class="col-md-12">
               <form class="form-horizontal" action="../util/joinUtil.jsp" style="padding : 150px; padding-bottom: 372px;'">
                  ...
                  <div class="form-group">
                     <label for="name" class="col-sm-2 col-sm-offset-1 control-label">PASSWD INSERT</label>
                     <div class="col-sm-8">
                        <input type="password" class="form-control" id="password" placeholder="PASSWD INSERT" name="password">
                     </div>
                  </div>
                  
               <div class="haha col-md-12">
                     <button class="btn btn-save sizeA" type="submit">SAVE</button>
                     <button class="btn btn-no sizeB" type="button" onclick="location.href='index.jsp' ">CANCEL</button>
               </div>
