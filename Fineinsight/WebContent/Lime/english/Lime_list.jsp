		...
		<div class="container" id="container">
			...
			<%@ include file="../include/header3.jsp"%>
				...
				<div class="card-header">
					<h2 class="line">
						<a href="Lime_list.jsp">CUSTOMOER ASK</a>
					</h2>
				</div>
				...
				<div class="card-body">
					...
					<div class="hoho col-md-7 no-padding">
						...
						<div class="lazenca2">
							<div class="totoyo">
								<a href="Lime_write.jsp"> <span class="btn-Lime btn" style="margin-top: -1px;margin-left: 206px;"> WRITE </span>
								</a>
							</div>
						</div>
					</div>
				...
				<div class="col-md-12 no-padding">
					<div class="table-responsive">
						<table id="data-table-selection" class="table table-condensed">
							<thead>
								<tr class="tr-color">
									<th class="table-sort">NO.</th>
									<th class="table-sort">CUSTOMER NAME</th>
									<th class="table-sort">WORK FLOW</th>
									<th class="table-sort">REQUEST TIME</th>
									<th class="table-sort">TIME OF RECEIPT</th>
									<th class="table-sort">WORK CATEGORY</th>
									<th class="table-sort">STAFF</th>
									<th class="table-sort">COTENTS OF REQUEST</th>
								</tr>
							</thead>
							<tbody>
								<%
