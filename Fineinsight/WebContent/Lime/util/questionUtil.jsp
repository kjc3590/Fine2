...
<%
	...
	try {
		...
		if(country.equals("korea")){
			response.getWriter().print("<script>alert('접수완료')</script>");
		response.getWriter().print("<script>location.href='../"+country+"/Lime_list.jsp'</script>");
		}else if(country.equals("china")){
			response.getWriter().print("<script>alert('接收完成')</script>");
		response.getWriter().print("<script>location.href='../"+country+"/Lime_list.jsp'</script>");
		}else if(country.equals("english")){
			response.getWriter().print("<script>alert('Reception Complete.')</script>");
		response.getWriter().print("<script>location.href='../"+country+"/Lime_list.jsp'</script>");
		}
