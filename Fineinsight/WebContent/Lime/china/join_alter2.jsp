            ...
            <div class="col-md-12">
               <form class="form-horizontal" action="../util/joinUtil.jsp" style="padding : 150px; padding-bottom: 372px;'">
                  ...
                  <div class="form-group">
                     <label for="name" class="col-sm-2 col-sm-offset-1 control-label">密码 输入</label>
                     <div class="col-sm-8">
                        <input type="password" class="form-control" id="password" placeholder="密码 输入" name="password">
                     </div>
                  </div>
                  
               <div class="haha col-md-12">
                     <button class="btn btn-save sizeA" type="submit">确定</button>
                     <button class="btn btn-no sizeB" type="button" onclick="location.href='index.jsp' ">取消</button>
               </div>
